...
Flash [`flash-packages/pinebuds-cros-v0.3.40.zip`](../flash-packages/pinebuds-cros-v0.3.40.zip) (both buds). Helper: [`firmware/stage_b/cros_bt_log.*`](../firmware/stage_b/cros_bt_log.h).
