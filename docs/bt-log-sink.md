...
Flash [`flash-packages/pinebuds-cros-v0.3.32.zip`](../flash-packages/pinebuds-cros-v0.3.32.zip) (both buds). Helper: [`firmware/stage_b/cros_bt_log.*`](../firmware/stage_b/cros_bt_log.h).
